...
void main()
{
	...
	//Scene scn("E:\\Models\\ClassRoom\\ClassRoom_No_Window\\classroom_No_Window.obj", false, true, vec3(-1.0f, 0.6f, 0.2f), 0.02, true, false, "Sky_19.hdr", 26.0f);// , look_from, false);
	...
	Scene scn("E:\\Models\\VolumeTric_Lighting_Room\\God_Ray_Room_High_Monkey.obj", false, true, vec3(-1.0f, 1.0f, -0.2f), 0.04, true, false, "Sky_19.hdr", 26.0f);
	...
	string image_name = "God_Ray_Room.ppm";
