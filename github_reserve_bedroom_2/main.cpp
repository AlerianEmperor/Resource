...
void main()
{
	...
	*/
		...
		for (int i = 0; i < Width; ++i)
		{
			...
			for (int s = 0; s < ns; s += step)
			{
				...
				for (int num = 0; num < step; ++num)
				{
					...
					vec3 current_color(scn.sibenik_tracing_directional_lighting_circle_blur_final_version_limit_cone(n, new_ray));
	...
	//string image_name = "picture_light_pos_2_pic_light_radius_1.0f_pdf_cylinder_scale_length_0.01_no_cos_view.ppm";

	string image_name = "Final_Light_scale_40_circle_light_radius_6.2.ppm";
